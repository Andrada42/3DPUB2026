...
public class TerrainGenerator3 : MonoBehaviour
{
    ...
    private void OnValidate()   // apelata la orice modificare in Inspector
    {
        ...
        {
            UnityEngine.Debug.LogError($"Object '{gameObject.name}' doesn't have the 'terrainMaterial' field assigned!", this);
        }
    }
    ...
    public void RunPerformanceTest()
    {
        ...
        UnityEngine.Debug.Log($"<color=orange>======== START PERFORMANCE TEST ========\n\t\t<b>RenderDistance:</b>\t{renderDistance} chunks</color>");
